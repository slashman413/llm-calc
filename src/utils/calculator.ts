...
const HARDWARE: Array<{ label: string; vram: number; note: string }> = [
  { label: 'Apple M-series 8 GB',      vram: 8,   note: 'Unified memory (shared CPU+GPU)' },
  { label: 'Apple M-series 16 GB',     vram: 16,  note: 'Unified memory (shared CPU+GPU)' },
  { label: 'Apple M-series 32 GB',     vram: 32,  note: 'Unified memory (shared CPU+GPU)' },
  { label: 'Apple M-series 64 GB',     vram: 64,  note: 'Unified memory (shared CPU+GPU)' },
  { label: 'NVIDIA RTX 3060 12 GB',    vram: 12,  note: 'Great for small models' },
  { label: 'NVIDIA RTX 4070 12 GB',    vram: 12,  note: 'Fast inference for small models' },
  { label: 'NVIDIA RTX 4070 Ti Super 16 GB', vram: 16, note: 'Handles 13B–34B well' },
  { label: 'NVIDIA RTX 4080 Super 16 GB',    vram: 16, note: 'Fast 16 GB card' },
  { label: 'NVIDIA RTX 4090 24 GB',    vram: 24,  note: 'Best consumer GPU for LLMs' },
  { label: 'NVIDIA RTX 6000 Ada 48 GB',vram: 48,  note: 'Professional workstation GPU' },
  { label: 'NVIDIA A100 80 GB',        vram: 80,  note: 'Data-center grade' },
  { label: 'CPU RAM only (32 GB)',      vram: 32,  note: 'Slow but works (llama.cpp)' },
  { label: 'CPU RAM only (64 GB)',      vram: 64,  note: 'Slow but works (llama.cpp)' },
  { label: 'CPU RAM only (128 GB)',     vram: 128, note: 'Slow but works (llama.cpp)' },
];
